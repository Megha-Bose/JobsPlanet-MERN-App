...
function createValidator(type, context, allConfigs) {
    ...
    return (node, modifiers = new Set()) => {
        ...
        for (const config of configs) {
            if (((_a = config.filter) === null || _a === void 0 ? void 0 : _a.test(originalName)) === false) {
                // name does not match the filter
                continue;
            }
            if ((_b = config.modifiers) === null || _b === void 0 ? void 0 : _b.some(modifier => !modifiers.has(modifier))) {
